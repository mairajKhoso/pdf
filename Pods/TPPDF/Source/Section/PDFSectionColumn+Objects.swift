...
public extension PDFSectionColumn {
	...
	*/
    public func addSpace(_ container: PDFSectionColumnContainer = PDFSectionColumnContainer.left, space: CGFloat,foreColor : UIColor = .clear) {
        objects += [(container, PDFSpaceObject(space: space,foreColor: foreColor))]
	}
